...
import TeamDetailsAravindRavichandran from "@/components/team/TeamDetails-aravind-ravichandran";
...
const TeamDetails = () => {
    return (
        <div>
            <Head>
                <title>Team - Aravindh Ravichandran</title>
            ...
            <RootLayout header="header1" footer="footer-usa" defaultMode="dark" customNavData={NavDataRook}>
                    <TeamDetailsAravindRavichandran />
                    <DigitalAgencyCTA />
                </RootLayout>
            </main>
        </div>
