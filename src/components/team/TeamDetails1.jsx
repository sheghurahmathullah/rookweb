...
import TeamDetails from "../../../public/assets/imgs/team/detail.webp";
          ...
          <div className="row">
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
              <div className="sec-title-wrapper pt-120">
                <h2 className="team__member-name-7 animation__char_come" ref={charAnim} >
                  Jessica <br />
                  Oliver
                </h2>
                <h3 className="team__member-role-7 animation__char_come" ref={charAnim2} >
