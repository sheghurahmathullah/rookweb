              ...
              <div className="team__items-7" ref={teamItemContent}>
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      ...
                      style={{ backgroundImage: "url(assets/imgs/team/1.webp)" }}
                    ></div>
                  </div>
                </Link>
                ...
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/2.webp)" }}
                    ></div>
                  </div>
                </Link>
                ...
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/3.webp)" }}
                    ></div>
                  </div>
                </Link>
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/4.webp)" }}
                    ></div>
                  </div>
                </Link>
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/5.webp)" }}
                    ></div>
                  </div>
                </Link>
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/6.webp)" }}
                    ></div>
                  </div>
                </Link>
                <Link href="/team-details">
                  <div className="team__item-7 fade_bottom_3">
                    ...
                    <div
                      className="team__hover-7"
                      style={{ backgroundImage: "url(assets/imgs/team/7.webp)" }}
                    ></div>
                  </div>
                </Link>
