...
const FooterContent = ({ footer, customThumbFooter }) => {
  if (footer == "footer1") {
    return <Footer1 />;
  } else if (footer == "footer2") {
    return <Footer2 />;
  } else if (footer == "footer3") {
    return <Footer3 customThumbFooter={customThumbFooter} />;
...
export default function RootLayout({
  ...
  useEffect(() => {
    setNavData(customNavData ?? allNavData);
      ...
      <CommonAnimation>
        ...
        <div id="smooth-wrapper">
          <div id="smooth-content">
            {children}
            <FooterContent footer={footer} customThumbFooter={customThumbFooter} />
          </div>
        </div>
