...
const StartupAgencyHero = () => {
          ...
          <div className="row">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              ...
              {/* <Image
               ...
               <strong>Exceed every aim with ease, and watch your brand find its voice, resonating deeply with those who have made the choice.</strong> <br />
  ...
  <div className="hero__right-6">
    <p ref={heroText}>
      <strong></strong> <br />
      We’re here to transform your social presence with tailored strategies that resonate deeply with your audience. Whether it’s engaging content, targeted ads, or building meaningful connections, our team is dedicated to driving the results that matter most to you. 
    </p>
  </div>
  <style jsx>{`
    .heroPadding {
